...
int defaultChipInfo(int i2cError){
	...
	ftsInfo.u8_msScrPnlCfgTuneVer =0;
	if(i2cError==1){
...
int readChipInfo(int doRequest) {
	...
	ftsInfo.u8_msScrPnlCfgTuneVer = data[index++];
	logError(1, "%s MS TUNING VWESION PANEL CONFIG = %02X \n", tag, ftsInfo.u8_msScrPnlCfgTuneVer);
