...
volatile int  g_tskit_ic_type = 0;
...
static int get_ts_board_info(void)
{
	...
	g_ts_kit_platform_data.i2c_hwlock.tp_i2c_hwlock_flag = 0;
	g_ts_kit_platform_data.aft_param.aft_enable_flag = 0;
...
static int __init huawei_ts_module_init(void)
{
    ...
    g_ts_kit_platform_data.ts_init_task = kthread_create((void*)ts_kit_init, &g_ts_kit_platform_data, "ts_init_thread:%d", 0);
    ...
    g_ts_kit_platform_data.ts_task = kthread_create((void*)ts_thread, &g_ts_kit_platform_data, "ts_thread:%d", 0);
