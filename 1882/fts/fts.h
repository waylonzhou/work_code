...
#define Y_AXIS_MAX                          2160						///< Max Y coordinate of the display
...
#define AREA_MIN	0	/* /< min value of Major/minor axis
					 * reported */
#define AREA_MAX	63	/* /< Man value of Major/minor axis
					 * reported */
/* **** END **** */
/**@}*/
/*********************************************************/
...
struct fts_hw_platform_data {
	...
	struct pinctrl_state *tp_int_pinctrl_state;
};
