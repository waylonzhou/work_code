...
static u8 bin_output=0;	/* /< Select the output type of the scriptless
...
static int chunk=0;	/* /< store the chuk of data that should be printed in
			 * this iteration */
static int printed=0;	/* /< store the amount of data already printed in the
			 * shell */
static struct proc_dir_entry *fts_dir=NULL;	/* /< reference to the directory
						 * fts under /proc */
static u8 *driver_test_buff=NULL;	/* /< pointer to an array of bytes used
